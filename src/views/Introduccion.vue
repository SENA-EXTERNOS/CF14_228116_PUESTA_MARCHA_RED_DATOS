...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    figure
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/ysw5Ux2xyCk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
...
.cajon-texto
  ...
  &__text
    width: 70%
    background-color: rgba(#CFE0EF, 0.9 )
    position: inherit
    right: 0
    top: 0
